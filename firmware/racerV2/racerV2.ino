...
#define VEL_MIN 0
#define VEL_MAX 255
#define VEL_CURVA 210
#define MIN_ERR_THR 330
...
uint32_t MAGENTA = pixel.Color(255,0,255); // magenta
...
void setupSensors() {
  qtr_side.setTypeRC();
  qtr_side.setSensorPins((const uint8_t[]){2,3}, 2);
  qtr_line.setTypeRC();
  qtr_line.setSensorPins((const uint8_t[]){A0,A1,A2,A3,A4,A5}, 6);
